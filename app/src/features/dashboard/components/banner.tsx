  ...
  return (
    <div className="text-white aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center rounded-xl bg-gradient-to-r from-[#2e62cb] via-[#0073ff] to-[#3faff5]">
      ...
      <div className="flex flex-col gap-y-2">
        <h1 className="text-xl md:text-3xl font-semibold">Create amazing gifts with ELYX</h1>
        <p className="text-xs md:text-sm mb-2">
          Design personalized digital gifts and stunning mini websites for every special occasion.
        </p>
        <Button
